...
class CalculatorClient:
    """A class for interacting with the calculator app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        CalculatorClient can be created with an app_id to interact with an existing application, alternatively
